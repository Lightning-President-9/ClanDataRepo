...
## Important Update
Up to June 2024, there was a significant upgrade of the database and the JavaScript employed in file exporting. The column name 'clancapitalattack' has been updated to 'clancapital'. Furthermore, headers in all file types, except PDF, have been sanitized for simpler handling in future use. On 31st July 2026 'MAY_2024' and 'JUN_2024' data is moved to separate directory for all 3 categories, as it was causing internal server error while fetching these months data in the website. 
